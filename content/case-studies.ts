...
export const caseStudies: CaseStudy[] = [
  {
    ...
    role: 'Backend Lead. I owned the microservice architecture, ML-pipeline orchestration, API design, and the backend foundation for real-time insight delivery.',
    stack: [
      'Python',
      'FastAPI',
      'Microservices',
  ...
  },
  {
    ...
    role: 'Senior Full-Stack Engineer. I built ingestion pipelines, data normalisation layers, APIs, and performance-focused dashboards with advanced filtering and search.',
    stack: [
      'React',
      'TypeScript',
      'Node.js',
