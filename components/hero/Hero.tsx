  ...
  return (
    <section className="hero" ref={heroRef}>
      <div className="shell hero__grid">
        ...
        >
          <motion.p className="eyebrow" variants={disabled ? undefined : itemVariants}>
            Senior full-stack engineer
          </motion.p>
          <motion.h1 variants={disabled ? undefined : itemVariants}>
            I design and build digital products that feel premium,
            <span> move sharply, and stay solid behind the scenes.</span>
          </motion.h1>
          <motion.p className="hero__summary" variants={disabled ? undefined : itemVariants}>
            {profile.summary}
          </motion.p>

          <motion.div className="hero__actions" variants={disabled ? undefined : itemVariants}>
          ...
          <motion.div className="hero__chips" aria-label="Proof points" variants={disabled ? undefined : itemVariants}>
            {proofChips.map((chip) => (
              <motion.span
                key={chip}
                className="chip"
        ...
        <motion.div
          ...
          initial={disabled ? false : { opacity: 0, scale: 0.92, rotateX: -10, y: 28 }}
          animate={
            disabled
              ? undefined
              : {
        ...
        >
          <motion.div
            ...
            animate={disabled ? undefined : { scale: [1, 1.06, 0.98, 1], opacity: [0.34, 0.5, 0.3, 0.34] }}
          ...
          <motion.div
            ...
            whileHover={disabled ? undefined : { y: -10, scale: 1.015, rotateZ: -1 }}
          >
            <Image
